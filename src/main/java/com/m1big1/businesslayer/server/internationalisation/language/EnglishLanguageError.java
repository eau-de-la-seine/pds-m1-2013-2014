 ...
 * @author Gokan EKINCI
 */
public class EnglishLanguageError implements ILanguageError {
    private static Logger logger = Logger.getLogger(EnglishLanguageError.class);
    ...
    static {  
        try {
            ...
            InputStream propertiesFile = classLoader.getResourceAsStream("languages/language_eng.properties");
            ...
            logger.fatal("Error when trying to load language_eng.properties", e);
        }
    }
