 ...
 * @author Gokan EKINCI
 */
public class FrenchLanguageError implements ILanguageError {
    private static Logger logger = Logger.getLogger(FrenchLanguageError.class);
    ...
    static {  
        try {
            ...
            InputStream propertiesFile = classLoader.getResourceAsStream("languages/language_fr.properties");
            ...
            logger.fatal("Error when trying to load language_fr.properties", e);
        }
    }
